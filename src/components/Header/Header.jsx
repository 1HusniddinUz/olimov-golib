                ...
                >
                    ...
                    <ul className={showheader ? "active" : ""}>
                        ...
                        <div className="market-dropdown">
                            <button className="market-btn">MARKETPLACES</button>
                            <div className="market-menu">
                                <a href="https://uzum.uz/uz/product/qolda-tayyorlangan-gips-mahsuloti-2079528" target="_blank" rel="noopener noreferrer">UZUM MARKET</a>
                                <a href="https://www.ozon.ru/product/gipsovoe-izdelie-ruchnoy-raboty-garmoniya-formy-estetiki-i-masterstva-3059074092/?oos_search=false" target="_blank" rel="noopener noreferrer">OZON</a>
                                <a href="https://www.wildberries.ru/catalog/595634857/detail.aspx?targetUrl=GP" target="_blank" rel="noopener noreferrer">WILDBERRIES</a>
                                <a href="https://market.yandex.uz/card/gipsovoye-izdeliye-ruchnoy-raboty--garmoniya-formy-estetiki-i-masterstva/4741610827?businessId=216456918&showOriginalKmEmptyOffer=1&ogV=-6" target="_blank" rel="noopener noreferrer">YANDEX MARKET</a>
                            </div>
                        </div>
                        <li>
